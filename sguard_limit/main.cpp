...
INT WINAPI WinMain(
	...
	if (!status) {
		MessageBox(0,
			"【更新说明】\n\n"
			" 内存补丁 V4：新增“高级内存搜索”功能（当前支持到Win11.22512）。\n\n"
			"1. 增加可调整的初始等待时间以免发生异常。\n\n"
			"2. 加快限制器的内存提交速度并解决一些机器上只提交【1/2】的问题。\n\n\n"
			
			"【重要提示】\n\n"
			"1. 本工具是免费软件，任何出售本工具的人都是骗子哦！\n\n"
			"2. “高级内存搜索”默认开游戏20秒后开始限制。\n"
			"   如果你想开游戏秒限制后台SG，可以在设置延时里把“初始等待时间”调到0；\n"
			"   但是据反馈，秒限制的话游戏可能在启动的时候偶尔闪退掉线。\n\n"
			"3. 默认模式为内存补丁，如果LOL不好用，可以切换模式“时间转轮”\n"
